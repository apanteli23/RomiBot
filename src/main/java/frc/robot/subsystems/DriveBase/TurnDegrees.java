...
public class TurnDegrees extends CommandBase {
  ...
  private final double m_degrees, m_speed;
  ...
  public void initialize() {
    ...
    m_drive.driveLeftMotor(0.0);
    m_drive.driveRightMotor(0.0);
  ...
  @Override
  public void execute() {
    m_drive.driveLeftMotor(m_speed);
    m_drive.driveRightMotor(-m_speed);
