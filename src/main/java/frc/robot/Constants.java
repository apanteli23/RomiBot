...
public final class Constants {
    ...
    public static final class DriveConstants {
        ...
        //DIO ports for drive encoders
        public static final int left_EncoderA = 4;
        public static final int left_EncoderB = 5;
        public static final int right_EncoderA = 6;
        public static final int right_EncoderB = 7;
